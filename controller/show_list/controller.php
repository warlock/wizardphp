...
while (!$result->EOF) {
	...
	?>
<th><form method="post" action="<? print $_go_update; ?>"><input type="hidden" name="action" value="read"><input type="hidden" name="id" value="<? print $result->fields["id"]; ?>"><input type="submit" value="<? t($wizard_model_name,"_go_update"); ?>"></form></th>
