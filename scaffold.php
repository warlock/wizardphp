		...
		case 'search':
			if(user('level') >= $wizard_model_complete[$wzd_segmento[$wzd_model_seg]]['_show'] or $wizard_config['mode'] == "development") { 
				...
				if ($wzd_need == $wzd_have) {
					print "Buscando en el modelo: ".$wzd_segmento[$wzd_model_seg]."<br>";
					print "Columnas: ".$wzd_segmento[$wzd_seg_act[2]]."<br>";
					print "Busqueda: ".$wzd_segmento[$wzd_seg_act[3]]."<br>";
				} else {
					print "No cuadra el query que estas realizando!";
				}
			}
			break;
		case 'new':
